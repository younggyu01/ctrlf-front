...
// 요일/주/월 단위 질문 수 + 에러율
export const CHATBOT_VOLUME_BY_PERIOD: Record<PeriodFilter, ChatbotVolumePoint[]> = {
    "7d": [
...
export const POPULAR_KEYWORDS_BY_PERIOD: Record<PeriodFilter, PopularKeyword[]> = {
    "7d": [
